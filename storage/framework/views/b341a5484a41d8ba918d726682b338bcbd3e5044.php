...
unset($__errorArgs, $__bag); ?> nagoyameshi-login-input" name="name" value="<?php echo e(old('name')); ?>" required autocomplete="name" autofocus placeholder="侍 太郎">
...
unset($__errorArgs, $__bag); ?> nagoyameshi-login-input" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" placeholder="samurai@samurai.com">
...
unset($__errorArgs, $__bag); ?> nagoyameshi-login-input" name="postal_code" required placeholder="150-0043">
                     </div>
                 </div>
...
unset($__errorArgs, $__bag); ?> nagoyameshi-login-input" name="address" required placeholder="東京都渋谷区道玄坂２丁目１１−１">
                     </div>
                 </div>
...
unset($__errorArgs, $__bag); ?> nagoyameshi-login-input" name="phone" required placeholder="03-5790-9039">
                     </div>
                 </div>
...
unset($__errorArgs, $__bag); ?> nagoyameshi-login-input" name="password" required autocomplete="new-password">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/kadai_002/laravel-nagoyameshi/resources/views/auth/register.blade.php ENDPATH**/ ?>